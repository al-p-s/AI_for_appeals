...
2. ConsiderationType — это статус рассмотрения обращения. Его значение может быть только 0, 1 или 2. (0 - обращение новое/не рассмотрено, 1 - повторное обращение, 2 - неоднократное обращение)
